...
namespace ProductsAPI.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateProduct(Product entity)
        {
            ...
            return CreatedAtAction(nameof(GetProduct), new { id = entity.ProductId }, entity); //201 created kodu
        }
        ...
        public async Task<IActionResult> UpdateProduct(int id, Product entity)
        {
            ...
            {
                return BadRequest();  // 400 hata kodu kullanıcı taraflı bir hatalı işlem yapıldı.
            }
            ...
            return NoContent(); // her şey yolunda 204 kod ama değer döndürmüyor
        }
